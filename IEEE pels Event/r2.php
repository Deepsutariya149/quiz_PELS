...
<html lang="en">
  ...
  <body>
    <div class="holder">
      ...
      <img src="assets/images/r2.jpeg" class="jumbotron testBox" id="test-box" style="margin-top: -5px; width: 400px;">
       <form action="r2db.php" method="POST" style="text-align: center; margin-top: -20px; margin-bottom: 10px;">
         <input type="test-box" name="r2ans">
