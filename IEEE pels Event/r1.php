...
<html lang="en">
  ...
  <body>
    <div class="holder">
      ...
      <!-- **************** mid section ********************** -->
      <div>
        <h4>Note :</h4><h5> Please Enter first latter capital Ex. Electrical</h5><h5> Enter Picture Name in Text Box</h5>
      <img src="assets/images/r1.jpeg" class="jumbotron testBox" id="test-box" style="margin-top: -5px; width: 600px;">
       <form action="r1db.php" method="POST" style="text-align: center; margin-top: -20px; margin-bottom: 10px;">
         <input type="test-box" name="r1ans">
