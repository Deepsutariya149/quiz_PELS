...
<html lang="en">
  ...
  <body>
    <div class="holder">
      ...
      <!-- **************** mid section ********************** -->
      <div>
        <h4>Note :</h4><h5> Please Enter first latter capital Ex. Electrical</h5>
      <img src="assets/images/r3.jpeg" class="jumbotron testBox" id="test-box" style="margin-top: -5px; width: 600px;">
       <form action="r3db.php" method="POST" style="text-align: center; margin-top: -20px; margin-bottom: 10px;">
         <input type="test-box" name="r3ans">
