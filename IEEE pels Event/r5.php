...
<html lang="en">
  ...
  <body>
    <div class="holder">
      ...
      <img src="assets/images/r5.jpg" class="jumbotron testBox" id="test-box" style="margin-top: -5px; width: 600px;">
       <form action="r5db.php" method="POST" style="text-align: center; margin-top: -20px; margin-bottom: 10px;">
         <input type="test-box" name="r5ans">
